...
class hash_machine(object):
    ...
    :type security:   bool
    :param raw_bytes:  Defaults to ``False``. Specifies whether the machine will accept binary data.
    :type raw_bytes:   bool
    ...
    def __init__(self, hash_type='sha256', encoding='utf-8', security=True, raw_bytes=False):
