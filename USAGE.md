...
_Encrypting a log-file into_ the Merkle-tree means updating it with each line of that file successively. Use the `.encryptPerLog` method to encrypt a new file as follows:
