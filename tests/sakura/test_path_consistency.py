...
perfect_nodes = [
    (tree_1, 0, 0, tree_1.leaf(0)),
    (tree_2, 0, 0, tree_2.leaf(0)),
    (tree_2, 0, 1, tree_2.root),
    (tree_2, 1, 0, tree_2.leaf(1)),
    (tree_3, 0, 0, tree_3.leaf(0)),
    (tree_3, 0, 1, tree_3.leaf(0).parent),
    (tree_3, 1, 0, tree_3.leaf(1)),
    (tree_3, 2, 0, tree_3.leaf(2)),
    (tree_4, 0, 0, tree_4.leaf(0)),
    (tree_4, 0, 1, tree_4.leaf(0).parent),
    (tree_4, 0, 2, tree_4.root),
    (tree_4, 1, 0, tree_4.leaf(1)),
    (tree_4, 2, 0, tree_4.leaf(2)),
    (tree_4, 2, 1, tree_4.leaf(2).parent),
    (tree_4, 3, 0, tree_4.leaf(3)),
    (tree_5, 0, 0, tree_5.leaf(0)),
    (tree_5, 0, 1, tree_5.leaf(0).parent),
    (tree_5, 0, 2, tree_5.leaf(0).parent.parent),
    (tree_5, 1, 0, tree_5.leaf(1)),
    (tree_5, 2, 0, tree_5.leaf(2)),
    (tree_5, 2, 1, tree_5.leaf(2).parent),
...
principal_nodes = [
    ...
    (tree_2, 0, []),
    (tree_2, 1, [(+1, tree_2.leaf(0))]),
    (tree_2, 2, [(+1, tree_2.root)]),
    (tree_3, 0, []),
    (tree_3, 1, [(+1, tree_3.leaf(0))]),
    (tree_3, 2, [(+1, tree_3.leaf(0).parent)]),
    (tree_3, 3, [
     (+1, tree_3.leaf(0).parent), (+1, tree_3.leaf(2))]),
    (tree_4, 0, []),
    (tree_4, 1, [(+1, tree_4.leaf(0))]),
    (tree_4, 2, [(+1, tree_4.leaf(0).parent)]),
    (tree_4, 3, [
     (+1, tree_4.leaf(0).parent), (+1, tree_4.leaf(2))]),
    (tree_4, 4, [(+1, tree_4.root)]),
    (tree_5, 0, []),
    (tree_5, 1, [(+1, tree_5.leaf(0))]),
    (tree_5, 2, [(+1, tree_5.leaf(0).parent)]),
    (tree_5, 3, [
     (+1, tree_5.leaf(0).parent), (+1, tree_5.leaf(2))]),
    (tree_5, 4, [(+1, tree_5.leaf(0).parent.parent)]),
    (tree_5, 5, [
     (+1, tree_5.leaf(0).parent.parent), (+1, tree_5.leaf(4))]),
]


complements = [
    (tree_0, [], []),
    (tree_1, [], [(+1, tree_1.leaf(0))]),
    (tree_1, [(+1, tree_1.root)], []),
    (tree_2, [], [(+1, tree_2.root)]),
    (tree_2, [(+1, tree_2.leaf(0))],
     [(+1, tree_2.leaf(1))]),
    (tree_2, [(+1, tree_2.root)], []),
    (tree_3, [], [(+1, tree_3.leaf(0).parent),
     (+1, tree_3.leaf(2))]),
    (tree_3, [(+1, tree_3.leaf(0))],
     [(+1, tree_3.leaf(1)), (+1, tree_3.leaf(2))]),
    (tree_3, [(+1, tree_3.leaf(0).parent)],
     [(+1, tree_3.leaf(2))]),
    (tree_3, [(+1, tree_3.leaf(0).parent),
     (+1, tree_3.leaf(2))], []),
    (tree_4, [], [(+1, tree_4.root)]),
    (tree_4, [(+1, tree_4.leaf(0))],
     [(+1, tree_4.leaf(1)), (+1, tree_4.leaf(2).parent)]),
    (tree_4, [(+1, tree_4.leaf(0).parent)],
     [(+1, tree_4.leaf(2).parent)]),
    (tree_4, [(+1, tree_4.leaf(0).parent), (+1,
     tree_4.leaf(2))], [(-1, tree_4.leaf(3))]),
    (tree_4, [(+1, tree_4.root)], []),
    (tree_5, [], [(+1, tree_5.leaf(0).parent.parent),
     (+1, tree_5.leaf(4))]),
    (tree_5, [(+1, tree_5.leaf(0))], [(+1, tree_5.leaf(1)),
     (+1, tree_5.leaf(2).parent), (+1, tree_5.leaf(4))]),
    (tree_5, [(+1, tree_5.leaf(0).parent)],
     [(+1, tree_5.leaf(2).parent), (+1, tree_5.leaf(4))]),
    (tree_5, [(+1, tree_5.leaf(0).parent), (+1, tree_5.leaf(2))],
     [(-1, tree_5.leaf(3)), (+1, tree_5.leaf(4))]),
    (tree_5, [(+1, tree_5.leaf(0).parent.parent)],
     [(+1, tree_5.leaf(4))]),
    (tree_5, [(+1, tree_5.leaf(0).parent.parent),
     (+1, tree_5.leaf(4))], []),
